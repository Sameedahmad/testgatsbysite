...
import BaseCard from "../../BaseCard" // plasmic-import: lLfxYG33Fqfk9Q/component
...
import * as sty from "./PlasmicPlan.module.css" // plasmic-import: dJc-b9L1sP2WGy/css
...
function PlasmicPlan__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box___3Dl4J)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___6QuKh)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__tnsmA)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__tsyUi)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__mKaim)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__wyanT)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.box__fI94I)}>
            {p.renderPlasmicSlot({
              defaultContents: (
