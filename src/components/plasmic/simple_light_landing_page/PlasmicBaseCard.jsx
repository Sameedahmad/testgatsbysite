...
import * as sty from "./PlasmicBaseCard.module.css" // plasmic-import: lLfxYG33Fqfk9Q/css
...
function PlasmicBaseCard__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box___483Sd, {
          [sty.box__long___483Sd0Uij]: hasVariant(variants, "long", "long"),
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__ueBsN, {
            [sty.box__long__ueBsN0Uij]: hasVariant(variants, "long", "long"),
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__ctTo4)}
                role={"img"}
              />
            ),
