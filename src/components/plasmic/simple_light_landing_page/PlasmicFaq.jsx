...
import * as sty from "./PlasmicFaq.module.css" // plasmic-import: YFpHwYd6z-m77Q/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__qbOch)}
      >
        <div className={classNames(defaultcss.all, sty.box__z6PfL)}>
          <div className={classNames(defaultcss.all, sty.box__vTa3A)}>
            {p.renderPlasmicSlot({
