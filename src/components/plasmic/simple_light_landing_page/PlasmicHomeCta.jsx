...
import * as sty from "./PlasmicHomeCta.module.css" // plasmic-import: mE-ZwwOgOQy9W/css
import SphereIcon from "./icons/PlasmicIcon__Sphere" // plasmic-import: S0UP023eqcigpZ/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__gXLg)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__mgcW)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box__blWux)}>
          <SphereIcon
