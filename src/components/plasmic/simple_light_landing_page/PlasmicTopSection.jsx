...
import * as sty from "./PlasmicTopSection.module.css" // plasmic-import: VE2HJ_qMhMvJN/css
import heroImageForT7KtHh79ZMf from "./images/heroImage.png" // plasmic-import: forT7KTHh79zMF/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__fyRrg)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__xq0HT)}
        >
          <div className={classNames(defaultcss.all, sty.box__bLqTf)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__kz5WX)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__blOgM)}
            text={"Start free trial"}
            type={"solidBlue"}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__smFWo)}
            text={"Learn more"}
            type={"solidBlack"}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box__gSxU)}>
          <img
